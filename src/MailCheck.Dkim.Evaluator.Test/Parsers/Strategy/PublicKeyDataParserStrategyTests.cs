...
namespace MailCheck.Dkim.Evaluator.Test.Parsers.Strategy
{
    ...
    public class PublicKeyDataParserStrategyTests
    {
        ...
        [TestCase("NOT BASE 64 STRING !!!", "Selector test-selector. Invalid value 'NOT BASE 64 STRING !!!' for p", EvaluationErrorType.Error, TestName = "non base 64 string invalid")]
        ...
        public void PublicKeyDataParserStrategy(string tokenValue, string errorMessageStartsWith, EvaluationErrorType? type)
        {
            ...
            EvaluationResult<Tag> publicKeyData = publicKeyDataParserStrategy.Parse("test-selector", tokenValue);
