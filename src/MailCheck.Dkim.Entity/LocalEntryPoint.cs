...
using MailCheck.Dkim.Entity.HistoryMigrator;
using MailCheck.Dkim.Entity.Seeding;
using Microsoft.Extensions.CommandLineUtils;

namespace MailCheck.Dkim.Entity
{
    public static class LocalEntryPoint
    {
        public static void Main(string[] args)
        {
            ...
            {
                CommandOption connectionString = command.Option("-c", "Connection String", CommandOptionType.SingleValue);
            ...
            commandLineApplication.Command("migrate-history", command =>
            {
                CommandOption connectionString = command.Option("-c", "Connection String", CommandOptionType.SingleValue);

                command.OnExecute(() =>
                {
                    IHistoryMigrator historyMigrator = HistoryMigratorFactory.Create(connectionString.Value());

                    historyMigrator.Process().GetAwaiter().GetResult();
